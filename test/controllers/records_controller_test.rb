  ...
  test "should create record" do
    assert_difference('Record.count') do
      post records_url, params: { record: {
        bath: @record.bath, clean: @record.clean, fece: @record.fece, handling: @record.handling,
        memo: @record.memo, reptile_id: @record.reptile_id, shed: @record.shed,
        tall: @record.tall, weight: @record.weight, day: @record.day
      } }
    end
